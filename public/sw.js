const CACHE_NAME = 'ia-moveis-v11-radar-sync';
const PRECACHE = ['/', '/dashboard', '/design-tokens.css?v=20260910-brown', '/styles.css?v=20260910-brown', '/dashboard-v2.css?v=20260910-brown', '/landing.css?v=20260910-brown', '/landing-v2.css?v=20260910-sci-fi-hero', '/landing.js?v=20260910-radar-sync', '/manifest.json', '/icon.svg'];
